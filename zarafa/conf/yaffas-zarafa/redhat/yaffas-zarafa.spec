...
BuildArch:  noarch
Requires:	php, php-cli, php-ldap, mysql-server, zarafa-webaccess, zarafa, yaffas-module-zarafalicence, yaffas-module-zarafaresources, yaffas-module-zarafaconf, yaffas-module-changelang, yaffas-module-zarafaorphanedstores, yaffas-module-zarafawebaccess, yaffas-module-zarafabackup, mod_ssl, yaffas-ldap, zarafa-webapp, zarafa-wa-plugins, zarafa-webapp-extbox, zarafa-webapp-quickitems, zarafa-webapp-titlecounter, zarafa-webapp-clockwidget, zarafa-webapp-folderwidgets, zarafa-webapp-pdfbox
