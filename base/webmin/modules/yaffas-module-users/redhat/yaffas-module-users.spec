...
Requires:	yaffas-install-lib, perl, yaffas-core, yaffas-module-authsrv, yaffas-module-mailalias, yaffas-module-mailsrv, yaffas-module-zarafaconf, php-pecl-json
AutoReqProv: no
