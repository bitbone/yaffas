...
for module in yaffas-ldap yaffas-samba yaffas-postfix yaffas-security yaffas-zarafa yaffas-software yaffas-module-security yaffas-module-mailalias z-push bitkit-ldap-tools yaffas-mail2fax; do
