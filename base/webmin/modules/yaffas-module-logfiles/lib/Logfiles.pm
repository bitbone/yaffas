...
sub get_filenames() {
	return (
			...
			"/var/log/auth.log",
			"/var/log/mail.warn",
			( Yaffas::Constant::OS eq 'Ubuntu' or Yaffas::Constant::OS eq "Debian" ? "/var/log/samba/log.nmbd" : "/var/log/samba/nmbd.log" ),
			( Yaffas::Constant::OS eq 'Ubuntu' or Yaffas::Constant::OS eq "Debian" ? "/var/log/samba/log.smbd" : "/var/log/samba/smbd.log" ),
			( Yaffas::Constant::OS eq 'Ubuntu' or Yaffas::Constant::OS eq "Debian" ? "/var/log/samba/log.winbind" : "/var/log/samba/winbindd.log" ),
			"/var/log/mysql.err",
			"/var/log/daemon.log",
