...
sub theme_header() {
	...
	if (!defined($ENV{REMOTE_USER}) or $ENV{'REMOTE_USER'} eq "") {
		my $file = Yaffas::File->new("zadmintheme/zadmin.css");
	...
	my $css = [];
		...
		$scripts = [
		 ...
		 $css = [
			...
			"/yui/assets/skins/zadmin/accordionview.css",
			"/yui/assets/skins/zadmin/tabview.css",
			"/yui/assets/skins/zadmin/container.css",
			"/yui/assets/skins/zadmin/button.css",
			"/yui/assets/skins/zadmin/paginator.css",
			"/yui/assets/skins/zadmin/datatable.css",
			"/yui/assets/skins/zadmin/menu.css",
			"/yui/assets/skins/zadmin/resize.css",
			"/yui/assets/skins/zadmin/treeview.css",
			"/yui/assets/skins/zadmin/layout.css",
