...
%post
# remove older zarafa clients such as zarafaclient-7.1.4-41819.msi
rm -f $(readlink /opt/software/zarafa/zarafaclient.msi)

# create a new symlink to the latest version
ln -sf /opt/software/zarafa/zarafaclient-7.1.4-41819.msi /opt/software/zarafa/zarafaclient.msi
...
/opt/software/zarafa/zarafaclient-7.1.4-41819.msi
